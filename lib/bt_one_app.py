...
class BTOneApp:
    def __init__(self, adapter_name, mac_address, alias=None, on_data_received=None, auto_reconnect=False, continuous=False, interval=-1):
        ...
        self.device = SolarDevice(mac_address=mac_address, manager=self.manager, on_resolved=self.on_resolved, on_data=self.on_data_received, auto_reconnect=auto_reconnect)
