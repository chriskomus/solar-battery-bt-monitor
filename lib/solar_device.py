...
class SolarDevice(gatt.Device):
    def __init__(
        ...
        notify_service_uuid=None,
        write_service_uuid=None,
        ...
        for service in self.services:
            for characteristic in service.characteristics:
                if (
                    ...
                    and characteristic.uuid == self.notify_char_uuid
                ):
                    characteristic.enable_notifications()
                    logging.info(
                        "subscribed to notification {}".format(characteristic.uuid)
                    )
                elif (
                    self.write_char_uuid and characteristic.uuid == self.write_char_uuid
                ):
                    self.write_characteristic = characteristic
                    logging.info(
                        "found write characteristic {}".format(characteristic.uuid)
                    )
    ...
    def characteristic_enable_notifications_failed(self, characteristic, error):
        logging.warn("characteristic_enable_notifications_failed")
    ...
    def characteristic_write_value_failed(self, characteristic, error):
        ...
        logging.warn("characteristic_write_value_failed")
